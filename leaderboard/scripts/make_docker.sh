#!/bin/bash
export CARLA_ROOT=/mnt/d/Lab6/CARLA_0.9.10/WindowsNoEditor
export SCENARIO_RUNNER_ROOT=/mnt/d/Lab6/transfuser/scenario_runner
export LEADERBOARD_ROOT=/mnt/d/Lab6/transfuser/leaderboard
export TEAM_CODE_ROOT=/mnt/d/Lab6/transfuser/team_code_transfuser
...
mv .tmp/PythonAPI/carla/dist/carla-0.9.10-py3.7-win-amd64.egg .tmp/PythonAPI/carla/dist/carla-leaderboard-py3x.egg 2>/dev/null || true
