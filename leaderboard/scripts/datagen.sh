export CARLA_ROOT=${1:-/media/amany-sherif/New Volume/transfuser/carla}
export WORK_DIR=${2:-/media/amany-sherif/New Volume/transfuser}


# Check if the number of arguments passed is less than 2
if [ "$#" -lt 2 ]; then
    echo "Usage: $0 <CARLA_ROOT_PATH> <WORK_DIR_PATH>"
    exit 1
fi

# Assign the arguments to variables with proper handling of spaces
CARLA_ROOT="$1"
WORK_DIR="$2"
